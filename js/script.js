...
$('#customers-testimonials-car').owlCarousel({
  interval: false,
  nav: true,
  navText: ["<div class='nav-button owl-prev'>‹</div>", "<div class='nav-button owl-next'>›</div>"],
  items: 3,
...
$('#customers-testimonials-aba').owlCarousel({
  interval: false,
  nav: true,
  navText: ["<div class='nav-button owl-prev'>‹</div>", "<div class='nav-button owl-next'>›</div>"],
  items: 3,
...
$('#customers-testimonials-flo').owlCarousel({
  interval: false,
  nav: true,
  navText: ["<div class='nav-button owl-prev'>‹</div>", "<div class='nav-button owl-next'>›</div>"],
  items: 3,
...
popupWhatsApp = () => {
  ...
  sendBtn_1.addEventListener("click", () => {
    ...
    window.open('https://wa.me/573105884818?text=' + relmsg, '_blank');
  });
